...
var config = {
    ...
    fontNames: ['宋体', '微软雅黑'],//['宋体', '微软雅黑', 'Arial', 'Tahoma', 'Verdana'],

    colors: ['#000000','#FF0000','#00FF00','#0000FF','#FFFF00','#FFFFFF','#00FFFF','#FF00FF','#666666','#444444', '#1C487F', '#4D80BF', '#C24F4A', '#8BAA4A', '#7B5BA1', '#46ACC8', '#F9963B'],
...
function FontSize(editor) {
    ...
    // 初始化 droplist
    /*, { $elem: $('<span style="font-size: x-large;">x-large</span>'), value: '5' }, { $elem: $('<span style="font-size: xx-large;">xx-large</span>'), value: '6' }*/
    this.droplist = new DropList(this, {
        width: 160,
        $title: $('<p>字号</p>'),
        type: 'list', // droplist 以列表形式展示
        list: [{ $elem: $('<span style="font-size: x-small;">x-small</span>'), value: '1' }, { $elem: $('<span style="font-size: small;">small</span>'), value: '2' }, { $elem: $('<span>normal</span>'), value: '3' }, { $elem: $('<span style="font-size: large;">large</span>'), value: '4' }],
        onClick: function onClick(value) {
            ...
            if (emotType === 'image') {
                content.forEach(function (item) {
                    ...
                    if (src) {
                        ...
                        faceHtml += '<span class="w-e-item"><img src="' + src + '" title="' + alt + '" data-w-e="1"/></span>';
                    }
                });
            }
...
var custMenuNameMap = {"Bold":"加粗","Italic":"斜体","Underline":"下划线","StrikeThrough":"删除线","Link":"超链接"
	,"Quote":"引用","Emoticon":"插入表情","Image":"插入图片","Table":"插入表格","Video":"插入视频","Undo":"撤销","Redo":"恢复"};
    ...
    _addToToolbar: function _addToToolbar() {
        ...
        objForEach(menus, function (key, menu) {
            ...
            if ($elem) {
                ...
                $elem.attr('title', custMenuNameMap[menu.constructor.name]);
...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('height', '88%');
        } else {
