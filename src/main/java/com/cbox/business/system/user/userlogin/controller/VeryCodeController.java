...
public class VeryCodeController extends BaseController {
    ...
    private int codeY;
    char[] codeSequence = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z', '1', '2', '3', '4', '5', '6', '7', '8', '9' };
    ...
    public void getImgCode(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        initxuan();
        // 定义图像buffer
        ...
        // System.out.println("获取验证码:----"+random);
        // 将图像填充为白色
        ...
        session.setAttribute(IMG_CODE_SESSION_KEY, randomCode.toString());
