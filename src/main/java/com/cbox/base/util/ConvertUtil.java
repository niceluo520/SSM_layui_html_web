...
public class ConvertUtil {
     ...
     * @return
     */
    public static Map<String, Object> list2Map(List<Map<String, Object>> dataList, String key) {
    ...
    public static Map<String, Object> beanToMap(Object model) {
        ...
        for (Field field : fieldList) {
            ...
            try {
                Method method = class1.getMethod("get" + Character.toUpperCase(fieldName.charAt(0)) + fieldName.substring(1), model.getClass());
            ...
            if (fieldValue != null) {
                if (fieldValue instanceof String) {
                    ...
                    // getConditionMap(fieldValue);// 处理查询参数
                }
            }
        }
        return resultMap;
    ...
    public static Object getFieldValueObj(Object model, Field field) {
        ...
        String fieldName = field.getName();
        try {
            Method method = localClass.getMethod("get" + Character.toUpperCase(fieldName.charAt(0)) + fieldName.substring(1), localClass);
